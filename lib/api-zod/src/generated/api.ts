 ...
 */
export const ListSkinInventoryResponseItem = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "skinName": zod.string(),
  "grantedAt": zod.string()
})
export const ListSkinInventoryResponse = zod.array(ListSkinInventoryResponseItem)


/**
 * @summary Give a skin to a user (moderator)
 */
export const GiveSkinBody = zod.object({
  "userId": zod.number(),
  "skinName": zod.string(),
  "accessCode": zod.string().optional()
})
 ...
 */
export const ListSkinInventoryForUserParams = zod.object({
  "userId": zod.coerce.number()
})

export const ListSkinInventoryForUserResponseItem = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "skinName": zod.string(),
  "grantedAt": zod.string()
})
export const ListSkinInventoryForUserResponse = zod.array(ListSkinInventoryForUserResponseItem)


/**
 * @summary Remove a skin from inventory (moderator)
 */
export const RemoveSkinParams = zod.object({
  "id": zod.coerce.number()
})
 ...
 */
export const ListCustomBordersResponseItem = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "imageData": zod.string(),
  "createdAt": zod.string()
})
export const ListCustomBordersResponse = zod.array(ListCustomBordersResponseItem)
...
export const CreateCustomBorderBody = zod.object({
  "name": zod.string().min(1),
  "imageData": zod.string()
})
 ...
 */
export const DeleteCustomBorderParams = zod.object({
  "id": zod.coerce.number()
})
 ...
 */
export const ListBorderInventoryResponseItem = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "borderName": zod.string(),
  "grantedAt": zod.string()
})
export const ListBorderInventoryResponse = zod.array(ListBorderInventoryResponseItem)


/**
 * @summary Give a border to a user (moderator)
 */
export const GiveBorderBody = zod.object({
  "userId": zod.number(),
  "borderName": zod.string(),
  "accessCode": zod.string().optional()
})
 ...
 */
export const ListBorderInventoryForUserParams = zod.object({
  "userId": zod.coerce.number()
})

export const ListBorderInventoryForUserResponseItem = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "borderName": zod.string(),
  "grantedAt": zod.string()
})
export const ListBorderInventoryForUserResponse = zod.array(ListBorderInventoryForUserResponseItem)


/**
 * @summary Remove a border from inventory (moderator)
 */
export const RemoveBorderParams = zod.object({
  "id": zod.coerce.number()
})
